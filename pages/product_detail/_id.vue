      ...
      <div class="card-content column is-two-thirds">
        ...
        <div class="card-content__reviews">
          <div class="is-pulled-right">
            <p>
              <strong>{{
                product.reviews > 0 ? `${product.reviews} نظر` : "نظری نیست"
              }}</strong>
            </p>
        <div class="card-content__price is-pulled-right mt-5">
          <span class="title is-3"
            ><strong>{{ product.price }} هزار تومان </strong></span
          >
        </div>
          </div>
        </div>
          <div class="select is-rounded is-small is-pulled-left">
        ...
        <div class="card-content__btn is-pulled-left mr-3 ml-3 mt-6">
          <button
...
export default {
  ...
  data() {
    return {
      ...
      removeFromCartLabel: "حذف از سبد",
      addToFavouriteLabel: "اضافه کردن به علاقه مندی ها",
      removeFromFavouriteLabel: "حذف از علاقه مندی ها",
      product: {},
      selected: 1,
      quantityArray: []
    };
